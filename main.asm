;----[ main.a - FM-Radio ]-----------
         ...
         .include inc_s("app")
         .include inc_s("colors")
         .include inc_s("ctxdraw")
         .include inc_s("io")
         .include inc_s("pointer")
         .include inc_s("switch")

         ;Kernal Module Constants

         .include inc_s("screen")
         .include inc_s("service")
...
externs  ;C64 OS KERNAL Link Table
         ...
         .include inc_h("screen")
         .include inc_h("util.frame")
...
ctxdraw  #syscall lscr,ctxdraw_
         ...
         .include inc_h("service")
quitapp  #syscall lser,quitapp_

         .include inc_h("toolkit")
